...
public class TokenRecuperacion {
    ...
    public TokenRecuperacion(Usuario usuario,String valor,int minutos){this.usuario=usuario;hashToken=hash(valor);expiraEn=emitidoEn.plus(Duration.ofMinutes(minutos));}
